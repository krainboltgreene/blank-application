defmodule HenosisWeb.UserSocket do
  use Phoenix.Socket
  use Absinthe.Phoenix.Socket, schema: HenosisWeb.Graphql.Schema
  ...
  #
  #     HenosisWeb.Endpoint.broadcast("user_socket:#{user.id}", "disconnect", %{})
  #
  ...
  defp account_from_session(%{"session_id" => id}) do
    Database.Repo.get(Henosis.Models.Account, id)
  end
end
