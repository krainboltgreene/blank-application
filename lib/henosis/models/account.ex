defmodule Henosis.Models.Account do
  use Ecto.Schema
  ...
  defp replace_email_with_unconfirmed_email(
         %Ecto.Changeset{changes: %Henosis.Models.Account{email: recorded_email}} = changeset,
  ...
  defp replace_email_with_unconfirmed_email(
         %Ecto.Changeset{data: %Henosis.Models.Account{email: nil}} = changeset,
         %{email: unconfirmed_email} = attributes
       )
