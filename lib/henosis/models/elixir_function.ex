defmodule Henosis.Models.ElixirFunction do
  use Ecto.Schema
  ...
  schema "elixir_functions" do
    ...
    field :hash, :string
    embeds_many :elixir_specs, Henosis.Models.ElixirFunctionSpec
    belongs_to :elixir_module, Henosis.Models.ElixirModule, primary_key: true
  ...
  @spec as_ast(%{
    ...
    elixir_module: %Henosis.Models.ElixirModule{slug: String.t()},
    elixir_specs: [%Henosis.Models.ElixirFunctionSpec{inputs: String.t(), return: String.t()}],
    guards: String.t(),
    inputs: String.t(),
    name: String.t(),
    slug: String.t(),
      ...
      [
        ...
        [
          do: {
            ...
            Enum.concat([
              [{:@, [], [{:doc, [], [documentation]}]}],
              Enum.map(elixir_specs, &Henosis.Models.ElixirFunctionSpec.as_ast/1),
