defmodule Henosis.Models.OrganizationMembership do
  use Ecto.Schema
  ...
  schema "organization_memberships" do
    belongs_to :organization, Henosis.Models.Organization, primary_key: true
    belongs_to :account, Henosis.Models.Account, primary_key: true
