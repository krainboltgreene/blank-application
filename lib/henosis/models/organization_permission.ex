defmodule Henosis.Models.OrganizationPermission do
  use Ecto.Schema
  ...
  schema "organization_permissions" do
    belongs_to :organization_membership, Henosis.Models.OrganizationMembership, primary_key: true
    belongs_to :permission, Henosis.Models.Permission, primary_key: true
