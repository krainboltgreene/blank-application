defmodule Blank.Models.Account do
  use Ecto.Schema
  ...
  def unconfirmed?(%Blank.Models.Account{unconfirmed_email: _}), do: true
  ...
  defp replace_email_with_unconfirmed_email(
         %Ecto.Changeset{changes: %Blank.Models.Account{email: recorded_email}} = changeset,
  ...
  defp replace_email_with_unconfirmed_email(
         %Ecto.Changeset{data: %Blank.Models.Account{email: nil}} = changeset,
         %{email: unconfirmed_email} = attributes
       )
