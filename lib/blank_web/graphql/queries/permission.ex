defmodule BlankWeb.Graphql.Queries.Permission do
  ...
  object :permission_queries do
    ...
    field :permissions, list_of(:permission) do
      ...
      resolve(&BlankWeb.Graphql.Resolvers.Permissions.list/3)
    end
    ...
    field :permission, :permission do
      ...
      middleware(&BlankWeb.Graphql.Middlewares.Sessions.require_authentication/2)
      resolve(&BlankWeb.Graphql.Resolvers.Permissions.find/3)
    end
  end
end
