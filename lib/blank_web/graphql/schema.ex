defmodule BlankWeb.Graphql.Schema do
  use Absinthe.Schema

  import_types(Absinthe.Type.Custom)

  import_types(BlankWeb.Graphql.Types.{
    Account,
    Permission,
    Organization,
    Session
  ...
  import_types(BlankWeb.Graphql.Queries.{
    Account,
    Permission,
    Organization,
    Session
  ...
  import_types(BlankWeb.Graphql.Mutations.{
    Account,
    Permission,
    Organization,
    Session
  ...
  import_types(BlankWeb.Graphql.Subscriptions.{
    Account,
    Permission,
    Organization,
    Session
