defmodule BlankWeb.Graphql.Resolvers.Sessions do
  ...
  def create(_parent, %{input: %{email: email, password: password}}, _resolution)
    ...
    Blank.Database.Repo.get_by(Poutioner.Models.Account, email: email)
    |> case do
      # Determine if the password is correct
      %Blank.Models.Account{} = account ->
    ...
    |> case do
      ...
      {true, %Blank.Models.Account{id: id}} -> {:ok, %{id: id}}
