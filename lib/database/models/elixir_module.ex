defmodule Database.Models.ElixirModule do
  ...
  schema "elixir_modules" do
    ...
    many_to_many :elixir_behaviours, Database.Models.ElixirModule, join_through: "elixir_behaviors"
    many_to_many :elixir_directives, Database.Models.ElixirModule, join_through: "elixir_directives"
