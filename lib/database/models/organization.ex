defmodule Database.Models.Organization do
  ...
  @spec join(Database.Models.Account.t(), String.t()) :: {:ok, Database.Models.Organization.t()} | {:error, Database.Models.Organization.t() | Ecto.Changset.t(Database.Models.Organization.t())}
  def join(account, organization_slug) do
    ...
    |> case do
      nil -> {:error, :not_found}
      organization ->
        Database.Models.OrganizationMembership.create(%{organization: organization, account: account})
    end
  end
