...
export default function CodeOfConduct (): JSX.Element {
  return <Page as="CodeOfConduct" kind="article" subtitle="Code Of Conduct">
    ...
    <ul>
      ...
      <li>
        Harshly criticizing the work of newer ClumsyChinchilla
      </li>
    ...
    <p>
      This Code of Conduct applies both within the community and in public spaces when an individual is representing ClumsyChinchilla or its community. Examples of representing a project or community include using an official e-mail address, posting via an official social media account, or acting as an appointed representative at an online or offline event. We reserve the right to redefine and clarify what representation means for ClumsyChinchilla in the future.
    </p>
    ...
    <p>
      This is version 1.0 of the <a href="https://www.clumsy-chinchilla.club">ClumsyChinchilla</a> Code of Conduct. It was prepared by Ellen McGrody for modification and maintenance by the ClumsyChinchilla administration team.
    </p>
