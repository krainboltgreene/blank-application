defmodule ClumsyChinchillaWeb.Graphql.Resolvers.Sessions do
  ...
  def create(_parent, %{input: %{email: email, password: password}}, _resolution)
    ...
    ClumsyChinchilla.Database.Repo.get_by(Poutioner.Models.Account, email: email)
    |> case do
      # Determine if the password is correct
      %ClumsyChinchilla.Models.Account{} = account ->
    ...
    |> case do
      ...
      {true, %ClumsyChinchilla.Models.Account{id: id}} -> {:ok, %{id: id}}
