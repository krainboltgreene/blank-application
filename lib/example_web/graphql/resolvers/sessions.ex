defmodule ExampleWeb.Graphql.Resolvers.Sessions do
  ...
  def create(_parent, %{input: %{email: email, password: password}}, _resolution)
    ...
    Example.Database.Repo.get_by(Poutioner.Models.Account, email: email)
    |> case do
      # Determine if the password is correct
      %Example.Models.Account{} = account ->
    ...
    |> case do
      ...
      {true, %Example.Models.Account{id: id}} -> {:ok, %{id: id}}
